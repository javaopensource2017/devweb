...
public class CalenderMy extends HtmlInputText implements org.primefaces.component.api.Widget {


	public static final String COMPONENT_TYPE = "com.is.faces.calender.CalenderMy";
	public static final String COMPONENT_FAMILY = "com.is.faces.calender";
	private static final String DEFAULT_RENDERER = "com.is.faces.calender.CalenderMyRenderer";
	private static final String OPTIMIZED_PACKAGE = "com.is.faces.calender.";
	...
	public UIComponent getAddBtn(){
		return getFacet("addBtn");
	}
	public void setAddBtn(UIComponent component){
		getFacets().put("addBtn", component);
	}
